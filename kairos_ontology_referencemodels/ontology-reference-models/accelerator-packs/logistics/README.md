...
| MMT | Multi-Modal Transport | `2.5.0` | Consignment, movement, cargo, equipment |
...
| supply-chain | Supply Chain | `1.5.0` | Cross-standard bridge properties linking DCSA, MMT, BSP, TIC, IMO, and WCO |
