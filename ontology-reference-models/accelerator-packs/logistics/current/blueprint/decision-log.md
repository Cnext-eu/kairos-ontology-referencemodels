...
| LOG-BP-003 | Booking authority | Investigate | Prefer DCSA `Booking` for carrier reservations. | BSP orders and TIC terminal orders have different grains and lifecycles. | High | `convergence-analysis.md` Booking and order |
