# PowerShell script to delete all GitHub labels
# This script activates the virtual environment and runs delete-all-labels.py

$ErrorActionPreference = "Stop"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "GitHub Labels Deletion Tool" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
$pythonScript = Join-Path $PSScriptRoot "delete-all-labels.py"
